...
class question_file_loader implements question_response_files {
    ...
    */
    ...
    public function get_question_file_saver() {
        ...
        // by and BD5 hash in a HTML comment. We only want the value in the latter case.
        if (preg_match('/\s*<!-- File hash: [0-9a-zA-Z]{32} -->\s*$/', $this->value)) {
            ...
            throw new coding_exception('$value passed to question_file_loader::get_question_file_saver was not of the expected form.');
        }
